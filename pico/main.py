...
from config import SSID, PASSWORD, MQTT_BROKER, MQTT_PORT, CLIENT_ID
...
TOPIC_DHT = b"sensor/dht22"
TOPIC_DS = b"sensor/ds18b20"
    ...
    try:
        ...
        if mqtt_connected:
            ...
            if t_dht is not None and h_dht is not None:
                ...
                mqtt_client.publish(TOPIC_DHT, msg_dht)
                print("📤 DHT22:", msg_dht)
            ...
            if roms:
                ...
                msg_ds = '{"temp":%.1f}' % t_ds
                mqtt_client.publish(TOPIC_DS, msg_ds)
