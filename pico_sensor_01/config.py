# ==========================================
# Growstar Pico Sensorcontroller 1
# ==========================================
# Der Pico ist NICHT an ein Zelt gebunden.
# Die Zuordnung erfolgt ausschließlich in Growstar per Drag & Drop.
...
# Sensor-Pins – entsprechen dem bisherigen Pico 1
DHT22_PIN = 15
DS18B20_PIN = 16
SAFE_MODE_PIN = 0
